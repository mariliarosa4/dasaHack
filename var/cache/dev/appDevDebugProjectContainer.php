...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\logcontroller' => 'AppBundle\\Controller\\LogController',
            'appbundle\\controller\\questionariocontroller' => 'AppBundle\\Controller\\QuestionarioController',
            'appbundle\\controller\\restcontroller' => 'AppBundle\\Controller\\RESTController',
        );
        $this->methodMap = array(
            '1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' => 'get1D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService',
            '2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' => 'get2D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService',
            'AppBundle\\Controller\\DashboardController' => 'getAppBundle_Controller_DashboardControllerService',
            'AppBundle\\Controller\\LogController' => 'getAppBundle_Controller_LogControllerService',
            'AppBundle\\Controller\\QuestionarioController' => 'getAppBundle_Controller_QuestionarioControllerService',
            'AppBundle\\Controller\\RESTController' => 'getAppBundle_Controller_RESTControllerService',
        ...
        $this->privates = array(
            '1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' => true,
            '2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' => true,
    ...
    /**
     * Gets the public 'AppBundle\Controller\LogController' shared autowired service.
     *
     * @return \AppBundle\Controller\LogController
     */
    protected function getAppBundle_Controller_LogControllerService()
    {
        return $this->services['AppBundle\Controller\LogController'] = new \AppBundle\Controller\LogController();
    }

    /**
     * Gets the public 'AppBundle\Controller\QuestionarioController' shared autowired service.
     *
     * @return \AppBundle\Controller\QuestionarioController
     */
    protected function getAppBundle_Controller_QuestionarioControllerService()
    {
        return $this->services['AppBundle\Controller\QuestionarioController'] = new \AppBundle\Controller\QuestionarioController();
    }

    /**
     * Gets the public 'AppBundle\Controller\RESTController' shared autowired service.
     *
     * @return \AppBundle\Controller\RESTController
     */
    protected function getAppBundle_Controller_RESTControllerService()
    {
        return $this->services['AppBundle\Controller\RESTController'] = new \AppBundle\Controller\RESTController();
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d']) ? $this->services['1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d'] : $this->get1D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d']) ? $this->services['2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d'] : $this->get2D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'ec2-54-86-129-169.compute-1.amazonaws.com', 'port' => NULL, 'dbname' => 'phoenix', 'user' => 'phoenix', 'password' => 'hackdasa', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->addCustomStringFunction('WEEK', 'DoctrineExtensions\\Query\\Mysql\\Week');
        $c->addCustomStringFunction('YEAR', 'DoctrineExtensions\\Query\\Mysql\\Year');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_baca5030552bd7cccd299ac387501fe99cb8bfac64da3453439011088469cdfe');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('web_dir', '/dasaHack/');
        $instance->addGlobal('link_dir', '/dasaHack/app_dev.php/');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7339095af25f9fc5d3e1542adac050acb2772224');
    }
    ...
    /**
     * Gets the private '1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService()
    {
        return $this->services['1_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2D089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085dService()
    {
        return $this->services['2_d089adae2c414233da05d5031af2e1985bcb2c62c309573c67ba19320cd5085d'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ASQLAmVlih', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MqTY6G0RiQ', 0, 'tVgRhQDircri+OgcaJUymB', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jikQ+-xJGR', 0, 'tVgRhQDircri+OgcaJUymB', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QoSn4WzQ+b', 0, 'tVgRhQDircri+OgcaJUymB', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a23dbdb214c15.00944505');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'ec2-54-86-129-169.compute-1.amazonaws.com',
            'database_port' => NULL,
            'database_name' => 'phoenix',
            'database_user' => 'phoenix',
            'database_password' => 'hackdasa',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '7339095af25f9fc5d3e1542adac050acb2772224',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '7339095af25f9fc5d3e1542adac050acb2772224',
