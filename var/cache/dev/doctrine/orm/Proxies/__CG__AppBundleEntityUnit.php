...
class Unit extends \AppBundle\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Unit' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Unit' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Unit' . "\0" . 'idCity'];
        }
